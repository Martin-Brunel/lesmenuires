...
export const AMENITY_ICON_OPTIONS: { value: AmenityIcon; label: string }[] = [
  ...
  { value: "car", label: "Parking / voiture" },
  ...
  { value: "snowflake", label: "Climatisation / fraîcheur" },
  { value: "heating", label: "Chauffage" },
  { value: "fireplace", label: "Cheminée / chauffage" },
  ...
  { value: "garden", label: "Jardin / extérieur" },
  ...
  { value: "ski", label: "Ski" },
  { value: "boot", label: "Local chaussures" },
  { value: "locker", label: "Casier / rangement" },
